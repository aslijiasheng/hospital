...
$yhq="优惠券号:".$b.":有效期：领取当日起一个月后作废,百达丽整形美容";
...
mysql_query("INSERT INTO cs_yhq (infoid,tel,yhq,lx,created_at,salesid_yhq) VALUES ('$yid','$_POST[phone]','$b','$_POST[lx]','$created_at','18')",$con);echo "优惠券已发送，请注意查收";
}
else{
if (mysql_query("INSERT INTO cs_info (name,xb,tel,mail,typeid,salesid,zxxm,created_at ) VALUES ('$_POST[user]','$_POST[sex]','$_POST[phone]','$_POST[email]','5','18','领取优惠券','$created_at')",$con)){$row2=mysql_fetch_array(mysql_query("select id,tel,name,salesid from `cs_info` WHERE tel='$_POST[phone]' limit 1",$con));
$Sender=$row2[id].",18";
$yid=$row2[id];
