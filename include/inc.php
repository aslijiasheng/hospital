...
$lang_cn =array( 
    ...
    "rabc_error_mobile"=>"<script>alert(\"找不到页面!\");window.location=\"mobile.php\";</script>", 
...
$action_cn=array( 
    ...
    "money"=>"金额管理表",
    "moneylist2"=>"客户消费表",
    "moneylist2PaidINAmount"=>"客户消费表实收金额",
    "moneylist2UnpaidaArrears"=>"客户消费表未收欠款",
    "moneypay"=>"收费管理",
    "moneypayadd"=>"收费写入",
    "doccontract"=>"合同列表",
    "doccontractnew"=>"添加合同",
    "doccontractedit"=>"修改合同",
    "doccontractshow"=>"合同明细",
    "doccontractdel"=>"删除合同",
...
function m_smarty_cfg($self){ 
    global $mt; 
    global $css; 
    $self->template_dir='./template/mobile'; 
    $self->cache_dir='./temp/m_cache'; 
    $self->compile_dir    ='./temp/m_compile'; 
    $self->assign('mt',$mt); 
    $self->assign('css',$css); 
}
