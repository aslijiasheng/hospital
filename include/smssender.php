<?php
$AddrArray=explode(' ','192.168.1.130');while(!in_array($_SERVER['SERVER_ADDR'],$AddrArray))die('本程序未在许可范围的服务器IP下使用！');$DomainArray=explode(' ','192.168.1.130');while(!in_array($_SERVER['SERVER_NAME'],$DomainArray))die('本程序未在许可范围的域名下使用！');?>
?<?php
