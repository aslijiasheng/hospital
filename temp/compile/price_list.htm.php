...
?>
			...
			<div id="priceBox" class="unitBox" style="float:left; width:78%; border:solid 1px #b8d0d6;border-top:none;borter-bottom:none; line-height:21px; background:#fff;">
			...
			<ul class="toolBar">
				...
				<li><a class="edit" href="?action=config&do=pinyin" target="dialog"><span>生成拼音</span></a></li>
				<li class="line">line</li>
			</ul>
			</div>
