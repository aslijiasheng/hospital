		...
		<input type="hidden" name="id" value="<?php echo $this->_var['row']['id']; ?>" />
			<div class="pageFormContent" >
				...
				<div class="unit">
					...
					<?php $_from = $this->_var['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'row_0_03923500_1407922676');if (count($_from)):
    foreach ($_from AS $this->_var['row_0_03923500_1407922676']):
?>
					<option value="<?php echo $this->_var['row_0_03923500_1407922676']['id']; ?>"><?php echo $this->_var['row_0_03923500_1407922676']['title']; ?></option>
