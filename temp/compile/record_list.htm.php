...
<div class="panelBar">
		<ul class="toolBar">
			<li><a title="确实要删除这些文件吗?" target="selectedTodo" rel="rz[]" href="?action=data&do=recorddel2" class="delete"><span>批量删除文件</span></a></li>
		</ul>
	</div>
			...
			<ul class="tree treeFolder" layouth="0">
				<li><a href="javascript">日志分类</a>
						<ul>		
							...
							<li><a href="?action=data&do=record&tid=mbfc" target="ajax" rel="recordBox">模板缓存文件</a></li>
