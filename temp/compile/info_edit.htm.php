<div class="page">
	<div class="pageContent">
		<form method="post" action="?action=info&do=edit" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
		...
		<input type="hidden" name="salesid" value="<?php echo $this->_var['row']['salesid']; ?>" />
			<div class="pageFormContent" layoutH="56">
				...
				<div class="unit">
					<label>客户电话：</label>
					<input name="tel" class="phone" type="text" size="30" value="<?php echo $this->_var['row']['tel']; ?>" alt=""/>
				</div>
				<div class="unit">
				<p>
					<label>预约时间：</label>
				...
				<div class="unit">
					<label>备注：</label>
					<textarea class="xheditor" name="intro" style="height:200px;width:65%"  tools="mini"><?php echo $this->_var['row']['intro']; ?></textarea>
				</div>
			</div>
			<div class="formBar">
				<ul>
