<form id="pagerForm" method="post" action="index.php?action=visits&type=0">
...
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="index.php?action=visits&type=0" method="post">
		<div class="searchBar">
