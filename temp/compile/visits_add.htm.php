<div class="page">
	<div class="pageContent">
		<form method="post" action="?action=visits&do=new" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		...
		<div class="tabsHeader">
			<div class="tabsHeaderContent">
				<ul>
					...
					<li><a href="javascript:;"><span>回访提醒</span></a></li>
		...
		<div class="tabsContent" style="height:100%;background:#fff;">
			<div>
				...
				<div class="unit">
				<label>客户满意度：</label>
				 <?php echo $this->_var['v_evaluate_cn']; ?>
				</div>
				<div class="unit">
				<label>回访备注：</label>
			...
			<div>
				...
				<div class="unit">
				<label>回访提醒：</label>
				<textarea  name="intro2" cols="48" rows="5" ></textarea> 
				</div>
			</div>
			<div>
				<div>
