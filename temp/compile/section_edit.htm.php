...
<div class="page">
	<div class="pageContent">
		...
		<input type="hidden" name="zid" value="<?php echo $this->_var['row']['zlid']; ?>" />
			...
			<tbody>			
			<?php $_from = $this->_var['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'row_0_20870800_1396605850');if (count($_from)):
    foreach ($_from AS $this->_var['row_0_20870800_1396605850']):
?>
				<tr target="id" rel="<?php echo $this->_var['row_0_20870800_1396605850']['id']; ?>" >
				<td><?php echo $this->_var['row_0_20870800_1396605850']['id']; ?></td>
					<td><?php echo $this->_var['row_0_20870800_1396605850']['title']; ?></td>
					<td><?php echo $this->_var['row_0_20870800_1396605850']['num']; ?></td>
					<td><?php echo $this->_var['row_0_20870800_1396605850']['num_z']; ?></td>
					<td ><input name="zlid[]" value="<?php echo $this->_var['row_0_20870800_1396605850']['id']; ?>" type="checkbox" checked="checked"></td>
				</tr>			
