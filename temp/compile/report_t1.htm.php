...
<div class="page">
	...
	<div class="pageContent">
		...
		<table class="list" layouth="65" style="width:250px">
			...
			<tbody>			
			<?php $_from = $this->_var['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'row_0_53897600_1396931209');if (count($_from)):
    foreach ($_from AS $this->_var['row_0_53897600_1396931209']):
?>
				<tr>
					<td><?php echo $this->_var['row_0_53897600_1396931209']['title']; ?></td>
					<td><?php echo $this->_var['row_0_53897600_1396931209']['num']; ?></td>
				</tr>
