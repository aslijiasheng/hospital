	...
	<div class="pageContent">
		...
		<input type="hidden" name="mt" value="1" />
			...
			<div class="divider">divider</div>
				...
				<div class="unit">
				<label>导出数据选择：</label>
					<input type="checkbox" name="dc_tel" value="tel" checked/>电话
					<input type="checkbox" name="dc_name" value="name" />姓名
					<input type="checkbox" name="dc_qq" value="qq" />QQ
					<input type="checkbox" name="dc_zxxm" value="zxxm" />预约项目
				</div>
			</div>
			<div class="formBar">
				<ul>
