			...
			function tdHtml(field){
				...
				switch(field.type){
					...
					case 'date':
						...
						break;
					case 'slider':
						html = '<script type="text/javascript" src="javascripts/cs.slider.js"></script><input name="'+field.name+'" class="'+field.fieldClass+'" style="width:100px" data-options="showTip: true">';
						break;
					default:
