    ...
    $.fn.bcalendar = function(option) {
        ...
        function BuildDayScollEventContainer(ht, dayarrs, events) {
            ...
            for (var i = 0; i < 24; i++) {
                ...
                ht.push("<div style=\"height: 41px\" class=\"tg-time\">", tmt, "</div>");//左时间
            }
            ht.push("</td>");
        ...
        function dayshow(e, data) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;overflow:hidden;border:1px solid #b8d0d6;" class="bubble"><div id="bubbleClose2" class="bubble-closebutton"></div><div class="bubble-table"><div id="bbit-cs-what" title="'
                    	+ i18n.xgcalendar.click_to_detail + '" class="textbox-fill-div lk" style="cursor:pointer;"></div><div id="bbit-cs-buddle-timeshow"></div><div class="bbit-cs-split"><input id="bbit-cs-id" type="hidden" value=""/>[ <span id="bbit-cs-delete" class="lk">'
                    	+ i18n.xgcalendar.i_delete + '</span> ]&nbsp; <SPAN id="bbit-cs-editLink" class="lk">'
                    	+ i18n.xgcalendar.update_detail + ' <StrONG>&gt;&gt;</StrONG></SPAN><div id="prong1" class="prong"><div class=bubble-sprite></div></div></div>';
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                var temparr = [];
                temparr.push('<div id="bbit-cal-buddle" style="z-index: 180; width: 400px;overflow:hidden;border:1px solid #b8d0d6;" class="bubble"><div id="bubbleClose6" class="bubble-closebutton"></div><link href="css/colorselect.css" rel="stylesheet" />  <script src="src/Plugins/Common.js" type="text/javascript"></script><script src="src/Plugins/jquery.colorselect.js" type="text/javascript"></script><script type="text/javascript"> $(document).ready(function() {var cv =$("#colorvalue").val() ;if(cv==""){cv="-1";} $("#color").colorselect({ title: "选择颜色", index: cv, hiddenid: "colorvalue" });});</script>  ');
                temparr.push('<div class="bubble-table" cellSpacing="0" cellPadding="0"><b>');
                temparr.push(i18n.xgcalendar.time, ':</b><span class="cs-bt" id="bbit-cal-buddle-timeshow"></span><div ><textarea  rows="5" cols="48" id="bbit-cal-what" class="textbox-fill-input"/></textarea></div><div><span class="cs-bt">选择日程颜色</span><span id="color" ></span><input id="colorvalue" name="colorvalue" type="hidden" value="" /></div><div><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/><input id="bbit-cal-allday" type="hidden"/><input id="bbit-cal-quickAddBTN" value="');
                temparr.push(i18n.xgcalendar.create_event, '" type="button"/>&nbsp; <SPAN id="bbit-cal-editLink" class="lk">');
                temparr.push(i18n.xgcalendar.update_detail, ' <StrONG>&gt;&gt;</StrONG></SPAN><div id="prong2" class="prong"></div></div></div>');
                ...
                var closebtn = $("#bubbleClose6").click(function() {
            ...
            $(document).one("mousedown", function() {
                $("#bbit-cal-buddle").css();//颜色弹出关父窗口css("visibility", "hidden")
                realsedragevent();
            });//颜色弹出关父窗口
            return false; 
        }
