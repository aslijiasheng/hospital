...
(function($) {
    ...
    $.fn.colorselect = function(option) {        
        ...
        var blanka = '<a href="#" id="{1}-{0}" key="{2}" hidefocus="on"><em><span style=" text-align:center; width:46px;padding-top:2px; height:11px;border:solid 1px #b8d0d6;" unselectable="on">none</span></em></a>'
        var blank = [];
        blank.push("ffffff");
        blank.push(id);
        blank.push(-1);
        ...
        if (options.index != -1) {
            ...
            leftdiv.css("border", "solid 1px #b8d0d6");
        }
        if (options.hiddenid != null && options.hiddenid != "") {
