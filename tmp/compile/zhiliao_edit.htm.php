<div class="page">
	<div class="pageContent">
		...
		<input type="hidden" name="id" value="<?php echo $this->_var['row']['id']; ?>" />
			...
			<tbody>			
			<?php $_from = $this->_var['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'row_0_12500200_1366608149');if (count($_from)):
    foreach ($_from AS $this->_var['row_0_12500200_1366608149']):
?>
				<tr target="id" rel="<?php echo $this->_var['row_0_12500200_1366608149']['id']; ?>" >
					<td style="display:none;"><input name="zlid[]" value="<?php echo $this->_var['row_0_12500200_1366608149']['id']; ?>" type="checkbox" checked="checked"></td>
					<td><input name="title[]" type="text" size="30" value="<?php echo $this->_var['row_0_12500200_1366608149']['title']; ?>" alt=""/></td>
					<td><input name="num[]" type="text" size="5" value="<?php echo $this->_var['row_0_12500200_1366608149']['num']; ?>" alt=""/></td>
					<td><?php echo $this->_var['row_0_12500200_1366608149']['num_z']; ?></td>
					<td><?php echo $this->_var['row_0_12500200_1366608149']['created_at']; ?></td>
				</tr>			
