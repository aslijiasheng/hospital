...
<div class="page">
	...
	<div class="pageContent">
		...
		<div class="tabsHeader">
			<div class="tabsHeaderContent">
				<ul>
					...
					<li><a href="javascript:;"><span>优惠券发送</span></a></li>
				</ul>
			</div>
		</div>
		<div class="tabsContent" style="height:100%;background:#fff;">
			...
			<div>
			  <iframe
src="<?php echo $this->_var['cfg']['app']; ?>?action=smsmail&do=ewmsc&id=<?php echo $this->_var['row']['id']; ?>" width="100%" height="100%" frameborder="no" background="translation" border="0" marginwidth="0" marginheight="0" scrolling="no"> </iframe>
