...
<div class="page">
	...
	<div class="pageContent">
		...
		<table class="list" layouth="91" style="width:95%;">
			...
			<tbody>			
			<?php $_from = $this->_var['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'row_0_31250100_1366611802');if (count($_from)):
    foreach ($_from AS $this->_var['row_0_31250100_1366611802']):
?>
				<tr target="id" rel="<?php echo $this->_var['row_0_31250100_1366611802']['id']; ?>,<?php echo $this->_var['row_0_31250100_1366611802']['infoid']; ?>,<?php echo $this->_var['row_0_31250100_1366611802']['sellid']; ?>" >
					<td><?php echo $this->_var['row_0_31250100_1366611802']['id']; ?></td>
					<td><?php echo $this->_var['row_0_31250100_1366611802']['created_at']; ?></td>
					<td><?php echo $this->_var['row_0_31250100_1366611802']['name']; ?></td>
					<td><?php echo $this->_var['row_0_31250100_1366611802']['xb']; ?></td>
					<td style="color:#f00;"><?php echo $this->_var['row_0_31250100_1366611802']['zhiliao_at']; ?></td>
					<td><?php echo $this->_var['row_0_31250100_1366611802']['salesid_txt']; ?></td>
					<td><?php echo $this->_var['row_0_31250100_1366611802']['dh_txt']; ?></td>
					<td><select class="sxm" <?php echo $this->_var['row_0_31250100_1366611802']['xs2']; ?>> <?php echo $this->_var['row_0_31250100_1366611802']['zxxm_txt']; ?><?php echo $this->_var['row_0_31250100_1366611802']['pd_txt']; ?></select><a class="an" href="?action=zhiliao&do=xmadd&id=<?php echo $this->_var['row_0_31250100_1366611802']['id']; ?>" target="dialog" rel="xmadd" <?php echo $this->_var['row_0_31250100_1366611802']['xs']; ?>>添加治疗项目</a></td>
					<td> <?php echo $this->_var['row_0_31250100_1366611802']['productid_txt']; ?></td>
					<td><?php echo $this->_var['row_0_31250100_1366611802']['doctorid_txt']; ?></td>
					<td><?php echo $this->_var['row_0_31250100_1366611802']['sellid']; ?></td>
					<td><?php echo $this->_var['row_0_31250100_1366611802']['state_txt']; ?></td>
					<td><select class="sxm2" title="<?php echo $this->_var['row_0_31250100_1366611802']['intro']; ?>"><option ><?php echo $this->_var['row_0_31250100_1366611802']['intro']; ?></option></select></td>
				</tr>			
