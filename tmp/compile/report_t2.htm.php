...
<div class="page">
	...
	<div class="pageContent">
		...
		<div id="cszt" style="min-width: 400px; height: 300px; margin: 0 auto;"></div>
			...
			<tbody>			
			<?php $_from = $this->_var['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'row_0_87500200_1366868454');if (count($_from)):
    foreach ($_from AS $this->_var['row_0_87500200_1366868454']):
?>
				<tr>
					<td><?php echo $this->_var['row_0_87500200_1366868454']['title']; ?></td>
					<td><?php echo $this->_var['row_0_87500200_1366868454']['num']; ?></td>
					<td><?php echo $this->_var['row_0_87500200_1366868454']['num2']; ?>个|初诊:<?php echo $this->_var['row_0_87500200_1366868454']['num2_c']; ?>|复诊:<?php echo $this->_var['row_0_87500200_1366868454']['num2_f']; ?></td>
					<td><?php echo $this->_var['row_0_87500200_1366868454']['num3']; ?></td>
					<td><?php echo $this->_var['row_0_87500200_1366868454']['num4']; ?></td>
				</tr>
