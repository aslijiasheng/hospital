...
<div class="page">
	<div class="pageContent">
			...
			<div class="content" <?php echo $this->_var['row']['xs2']; ?>>
				...
				<?php $_from = $this->_var['list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'row_0_17187600_1366608427');if (count($_from)):
    foreach ($_from AS $this->_var['row_0_17187600_1366608427']):
?>
				<table id="listhf" target="id" rel="<?php echo $this->_var['row_0_17187600_1366608427']['id']; ?>">
				<tr >
				<td class="lf" valign="top" ><img class="tx" src="" width="50" height="50"/><br/>by：<span class="zz"><?php echo $this->_var['row_0_17187600_1366608427']['salesid_txt']; ?></span></td>
				<td class="rf"><?php echo $this->_var['row_0_17187600_1366608427']['title_r']; ?><div class="jju"></div><span class="sm">&#9758;---- <?php echo $this->_var['row_0_17187600_1366608427']['created_at']; ?> <a class="hfr" href="?action=doc&do=reply&hid=<?php echo $this->_var['row_0_17187600_1366608427']['id']; ?>" target="dialog">[回复]</a></span><div class="jju"></div>
				<div class="z_hf" <?php echo $this->_var['row_0_17187600_1366608427']['xs']; ?>><?php echo $this->_var['row_0_17187600_1366608427']['intro_r']; ?></div></td>
				</tr></table>		
